      ...
      <div class="footer-container">
        <div class="footer-content">
          ...
          <div class="footer-links">
            <div class="link-section">
              <h4>서비스</h4>
              <ul>
                <li><button class="footer-link" on:click={() => changePage('services')}>웹 개발</button></li>
                <li><button class="footer-link" on:click={() => changePage('services')}>모바일 앱</button></li>
                <li><button class="footer-link" on:click={() => changePage('services')}>UI/UX 디자인</button></li>
                <li><button class="footer-link" on:click={() => changePage('services')}>클라우드 솔루션</button></li>
              </ul>
            </div>
            ...
            <div class="link-section">
              <h4>회사</h4>
              <ul>
                <li><button class="footer-link" on:click={() => changePage('company')}>소개</button></li>
                <li><button class="footer-link" on:click={() => changePage('company')}>팀</button></li>
                <li><button class="footer-link" on:click={() => changePage('company')}>채용</button></li>
                <li><button class="footer-link" on:click={() => changePage('company')}>뉴스</button></li>
              </ul>
            </div>
            ...
            <div class="link-section">
              <h4>지원</h4>
              <ul>
                <li><button class="footer-link" on:click={() => changePage('support')}>고객센터</button></li>
                <li><button class="footer-link" on:click={() => changePage('support')}>문의하기</button></li>
                <li><button class="footer-link" on:click={() => changePage('support')}>FAQ</button></li>
                <li><button class="footer-link" on:click={() => changePage('support')}>개발자 문서</button></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="footer-bottom">
          <div class="footer-bottom-content">
            <p class="copyright">© 2024 Firsti. All rights reserved.</p>
